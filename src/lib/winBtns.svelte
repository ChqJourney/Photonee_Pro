...
<div class="flex gap-2">
  <div class="w-6"></div>
    <button on:click={async()=>{
      ...
      }} class="w-6 h-6 rounded-md items-center flex hover:bg-slate-400 fill-slate-200 hover:fill-white justify-center" id="titlebar-minimize">
    ...
    }} class="reletive rounded-md fill-slate-200 flex items-center justify-center hover:bg-slate-400 hover:fill-white w-6 h-6" id="titlebar-maximize">
    ...
    {/if}
    <button class="w-6 h-6 rounded-md fill-slate-200 items-center hover:bg-slate-400 hover:fill-white flex justify-center" on:click={async()=>await appWindow.close()} id="titlebar-close">
