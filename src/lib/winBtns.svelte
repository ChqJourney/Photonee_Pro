...
<div class="flex gap-2">
    <button on:click={async()=>await appWindow.hide()} class="w-6 items-center flex justify-center" id="titlebar-minimize">
      <svg class="h-3 w-3 stroke-black" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"  width="200" height="200"><path d="M960 544H64a32 32 0 1 1 0-64h896a32 32 0 1 1 0 64"></path></svg>
    </button>
    ...
    }} class="reletive flex justify-center w-6" id="titlebar-maximize">
    ...
    <button class="w-6 flex justify-center" on:click={async()=>await appWindow.close()} id="titlebar-close">
